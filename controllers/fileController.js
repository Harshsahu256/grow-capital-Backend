...
//     // ✅ 1. Find the file (NOT create new)
...
//     if (file.approved) {
//       return res.status(400).json({ message: "File already approved!" });
//     }

//     console.log("Found file:", file);

//     // ✅ 2. User ID already present inside file.uploadedBy
//     const userId = file.uploadedBy;
//     console.log("User ID = ", userId);

//     // ✅ 3. Update file fields
//     file.amount = amount;
//     file.approved = true;
//     await file.save();

//     // ✅ 4. Update user's total amount
